 ...
 * esta classe visa eliminar da tela principal de login a logica utilizada para fazer login na aplicação
 * deixando a tela mais limpa e focada nos componetes de visualização do usuario.
 */
    ...
    public Connection getConnection(String servidor, String usuario,String senha){
     this.nomeServidor=servidor;
      ...
      try {
        ...
        try {
            System.out.println("esta e sua string"+url);
